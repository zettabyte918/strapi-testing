...
class StrapiApp {
  ...
  createCustomConfigurations = async () => {
    ...
    if (this.customConfigurations?.headingTitle?.title && this.customConfigurations?.headingTitle?.subTitle) {
      this.configurations.headingTitle = this.customConfigurations.headingTitle;
    }
  ...
  render() {
    ...
    return (
      <Theme theme={this.configurations.theme}>
        <Providers
          headingTitle={this.configurations.headingTitle}
